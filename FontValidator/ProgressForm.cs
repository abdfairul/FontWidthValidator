...
namespace FontValidator
{
    ...
    public partial class ProgressForm : Form
    {
        ...
        public void SetReportProgress(bool i_set)
        {
            worker.WorkerReportsProgress = i_set;
        }

        public void SetSupportCancel(bool i_set)
        {
            worker.WorkerSupportsCancellation = i_set;
        }
